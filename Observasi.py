...
#     spreadsheet_name = "OBSERVASI ALL BU"
#     sheet = client.open(spreadsheet_name)

#     # === ambil sheet observasi ===
#     naemSheetDok = "DOKUMENTASI"
#     sheet_dok = client.open(naemSheetDok)
#     ws_observasi = sheet.worksheet("Observasi")
#     values_observasi = ws_observasi.get("E:N")
